...
export const AddedTasksView: React.FC = () => {
  ...
  const [filteredResults, setFilteredResults] = useState<AddedTaskItem[] | null>(null);
  ...
  return (
    <div className="space-y-6 font-arabic max-w-6xl mx-auto p-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Top Buttons */}
      <div className="flex flex-wrap gap-3 bg-white p-4 rounded-xl shadow-sm border border-slate-200">
